      ...
      <ul id="wd-modules">
        <li className="wd-module">
          ...
          <ul className="wd-lessons">
            ...
            <li className="wd-lesson">
              <span className="wd-title">
                Week 1, Lecture 3 - Styling User Interfaces with CSS
              </span>
              <ul className="wd-content">
                <li className="wd-content-item">
                  <span className="wd-title">LEARNING OBJECTIVES</span>
                  <ul className="wd-content">
                    <li className="wd-content-item">
                      Understand CSS rules and selectors
                    </li>
                    <li className="wd-content-item">
                      Style text, spacing, and colors
                    </li>
                  </ul>
                </li>
                <li className="wd-content-item">
                  ...
                  <ul className="wd-content">
                    ...
                    <li className="wd-content-item">
                      Full Stack Developer - Chapter 4 - Layout Basics
                    </li>
                  </ul>
                </li>
                <li className="wd-content-item">
                  ...
                  <ul className="wd-content">
                    ...
                    <li className="wd-content-item">Flexbox Introduction</li>
                  </ul>
                </li>
              </ul>
            </li>
